...
export default function Home() {
  return (
    <div className="grid md:grid-rows-4 md:grid-cols-3 md:max-h-screen overflow-hidden w-full gap-8 pt-32 pb-4 grid-rows-1 grid-cols-1 text-white">

      <div className="col-span-2 row-span-2 rounded-xl h-full">
        <WelcomeCard />
      </div>
      
      <div className="col-span-1 row-span-2 bg-request-orange rounded-xl p-6">
        <LogoCard/>
      </div>
